...
$string['note'] = 'This block is hidden from students';
$string['yes'] = 'Yes';
$string['no'] = 'No';
$string['editsections'] = '&raquo; Edit Sections';
$string['addnewsectionsafterselected'] = 'Add New Section';         #'Add new course section after selected';
$string['reordersections'] = 'Update';                  #'Reorder and/or submit section changes';
$string['removeselected'] = 'Remove';                   #'Remove selected';
$string['returntocourse'] = 'Discard changes';         #'Return to course, discard unsaved changes';
